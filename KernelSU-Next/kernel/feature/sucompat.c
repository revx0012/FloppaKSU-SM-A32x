...
{
	// floppaksu: force-enable su compat so allowlisted apps can always use su,
	// regardless of the manager's toggle (requested value is ignored on purpose).
	ksu_su_compat_enabled = true;
	pr_info("su_compat: force-enabled (request=%llu ignored)\n", value);
	return 0;
}
