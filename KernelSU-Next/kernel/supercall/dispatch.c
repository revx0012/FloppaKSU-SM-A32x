...
static int do_susfs_set_cmdline(void __user *arg)
{
...
static int do_susfs_run_umount(void __user *arg)
{
...
static const struct ksu_ioctl_cmd_map ksu_ioctl_handlers[] = {
    ...
    {
        .cmd = KSU_IOCTL_SUSFS_ADD_TRY_UMOUNT,
    ...
    {
        .cmd = KSU_IOCTL_SUSFS_ENABLE_LOG,
        .name = "SUSFS_ENABLE_LOG",
        .handler = do_susfs_enable_log,
        .perm_check = manager_or_root
    },
    {
        .cmd = KSU_IOCTL_SUSFS_SET_CMDLINE,
        .name = "SUSFS_SET_CMDLINE",
        .handler = do_susfs_set_cmdline,
        .perm_check = manager_or_root
    },
    {
        .cmd = KSU_IOCTL_SUSFS_ADD_OPEN_REDIRECT,
        .name = "SUSFS_ADD_OPEN_REDIRECT",
        .handler = do_susfs_add_open_redirect,
        .perm_check = manager_or_root
    },
    {
        .cmd = KSU_IOCTL_SUSFS_SHOW_VERSION,
        .name = "SUSFS_SHOW_VERSION",
        .handler = do_susfs_show_version,
        .perm_check = manager_or_root
    },
    {
        .cmd = KSU_IOCTL_SUSFS_SHOW_FEATURES,
        .name = "SUSFS_SHOW_FEATURES",
        .handler = do_susfs_show_features,
        .perm_check = manager_or_root
    },
    {
        .cmd = KSU_IOCTL_SUSFS_SHOW_VARIANT,
        .name = "SUSFS_SHOW_VARIANT",
        .handler = do_susfs_show_variant,
        .perm_check = manager_or_root
    },
    {
        .cmd = KSU_IOCTL_SUSFS_ADD_SUS_KSTAT_STATICALLY,
        .name = "SUSFS_ADD_SUS_KSTAT_STATICALLY",
        .handler = do_susfs_add_sus_kstat_statically,
        .perm_check = manager_or_root
    },
    {
        .cmd = KSU_IOCTL_SUSFS_RUN_UMOUNT,
        .name = "SUSFS_RUN_UMOUNT",
        .handler = do_susfs_run_umount,
        .perm_check = manager_or_root
    },
#endif
    {
